...
About:
This is a technological demo, demonstrating the WaterPlay features.
It shows how Dizzy can swim in Spellbound style.
Empty-handed, with flippers, with scuba costume, and with both flippers and scuba.
This demo also features the colored Dizzy tiles, just for fun!
