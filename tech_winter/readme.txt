...
About:
This is a technological demo, demonstrating the snow fx.
It uses some dynamic brushes, one for each snow flake and moves them
from an AI update function. See it in ai.gs.
You can optimize it further by avoiding to have an empty corner caused 
by the wind pushing the flakes sideway.
...
Story:
No story here, just two empty rooms.
No puzzles, not smart things.
