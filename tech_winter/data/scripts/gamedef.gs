...
#def GAME_TITLE			"Winter Demo"						// game's title (for the window title)
#def GAME_WEBSITE 		"http://www.yolkfolk.com/dizzyage"	// game's website (for the final dialog)
#def GAME_ID			"WD080201"							// game's id text, used in saved games - change this when you release a new version, to prevent old saved games to be loaded.
...
#def PLAYER_BEGINX		360		// set the starting positon x of the player in map (when a new game begins)
