...
About:
This is a technological demo, demonstrating the custom movement.
It shows how Dizzy can walk default (update by engine), 
custom (updated by script) and custom shrinked (also in script).
