...
#def MAXINVENTORY		5		// max number of inventory items ( max 10 items )
...
#def PLAYER_BEGINX		540		// set the starting positon x of the player in map (when a new game begins)
